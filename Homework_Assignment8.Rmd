...
```
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/state-region-distribution-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-1-1.png)

The smaller we make the bins, the smoother the histogram gets. Here are the histograms with bin width of 1, 0.5, and 0.1:

![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-2-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-density-1-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/smooth-density-2-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/densities-different-smoothness-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/area-under-curve-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-2-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/two-densities-one-plot-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-exercise-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-2-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-exercise-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-2-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/normal-distribution-density-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/data-and-normal-densities-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/hist-qqplot-non-normal-data-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/first-boxplot-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-1.png)
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/histogram-qqplot-female-heights-1.png)
...
heigt_quantile <- data.frame(p, male_percentiles, female_percentiles)
heigt_quantile
```

3\. Study the following boxplots showing population sizes by country:

![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-exercise-1.png)
...
m <- mean(x)
s <- sd(x)
app <- pnorm(81, mean = m, sd = s) - pnorm(79, mean = m, sd = s) 
act/app
```
1.614
...
![Benjamin Bannekat](https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-geom-1.png)
...
heights %>% 
  ...
  geom_density() 
```
However, here the second density is drawn over the other. We can make the curves more visible by using alpha blending to add transparency. Set the alpha parameter to 0.2 in the geom_density function to make this change.```{r}
```{r}
heights %>% 
  ggplot(aes(height, fill = sex)) + 
